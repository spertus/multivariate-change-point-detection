...
\begin{frame}{Optimal CAD and regret in Gaussian VAR}
  \centering
  \includegraphics[width=0.7\linewidth]{figures/simulations/cad/joint_oracle_vs_bounded.png}\\
\end{frame}
...
\begin{frame}{Empirical: detector trajectory on 2025--2026 season}
  \begin{columns}[T,onlytextwidth]
      \column{0.5\textwidth}
      \includegraphics[width = 0.9\linewidth]{figures/nwmp/pipeline-plot-2.png}\\
      \scriptsize
...
\begin{frame}{Simple approach: threshold signals}
    \begin{columns}[T,onlytextwidth]
      \column{0.5\textwidth}
      \includegraphics[width=0.9\linewidth]{figures/nwmp/threshold-baseline-test-1.png}\\
      \scriptsize
...
\begin{frame}{Appendix: CAD for bet windowing strategies over $\nu$}
    \centering
    \includegraphics[width = \textwidth]{figures/simulations/cad/bounded_nu_cad.png}\\
    \scriptsize
...
\begin{frame}{Appendix: Computation time for bet windowing strategies}
    \centering
    \includegraphics[width = \textwidth]{figures/simulations/cad/bounded_w_comp_time.png}\\
    \scriptsize
